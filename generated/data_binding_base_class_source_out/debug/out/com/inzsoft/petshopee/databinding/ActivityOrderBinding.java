...
public final class ActivityOrderBinding implements ViewBinding {
  ...
  private ActivityOrderBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout frameLayout,
      @NonNull FrameLayout frameLayout2, @NonNull ImageView imageView7, @NonNull TextView offid,
      @NonNull RecyclerView orderrecycle) {
  ...
  public static ActivityOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.orderrecycle;
      RecyclerView orderrecycle = ViewBindings.findChildViewById(rootView, id);
      if (orderrecycle == null) {
        break missingId;
      }

      return new ActivityOrderBinding((ConstraintLayout) rootView, frameLayout, frameLayout2,
          imageView7, offid, orderrecycle);
    }
